...
with pestana_reviews:
    ...
    col_descarga_reviews, col_descarga_resumen, col_descarga_png = st.columns(3)
    ...
    with col_descarga_png:
        st.info(
            "PNG disponible\n\n"
            "Pasa el cursor sobre una gráfica y utiliza el icono de cámara para descargarla."
        )
